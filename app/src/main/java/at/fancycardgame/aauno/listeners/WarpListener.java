...
/**
 * Created by Philip on 02.06.2015.
 */
public class WarpListener implements RoomRequestListener, NotifyListener {
    ...
    public void onUpdatePeersReceived(UpdateEvent event) {
        //Toast.makeText(gameScreen, "Swaghetti Yolognese", Toast.LENGTH_SHORT).show();
        Tools.showToast("Yoyoyo", 5);
        if(event.isUDP()){
            ...
            if(message.startsWith("_")){// Result Message
                ...
                if(!sender.equals(Util.userName)){// Update Message
